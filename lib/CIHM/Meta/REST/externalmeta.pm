package CIHM::Meta::REST::externalmeta;
...
CIHM::Meta::REST::externalmeta - Subclass of Role::REST::Client used to
interact with "externalmeta" CouchDB databases

=head1 SYNOPSIS

    my $t_repo = CIHM::Meta::REST::externalmeta->new($args);
...
sub get_attachment {
    ...
    if ( $res->code == 200 ) {
        ...
        warn "get_attachment return code: " . $res->code . "\n";
        return;
    }
}
