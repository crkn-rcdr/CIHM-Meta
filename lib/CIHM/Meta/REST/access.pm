...
CIHM::Meta::REST::access - Subclass of Role::REST::Client used to
interact with "access" CouchDB database

=head1 SYNOPSIS

    my $t_repo = CIHM::Meta::REST::access->new($args);
