package CIHM::Meta::REST::cosearch;
...
CIHM::Meta::REST::cosearch - Subclass of Role::REST::Client used to
interact with "cosearch" CouchDB databases

=head1 SYNOPSIS

    my $t_repo = CIHM::Meta::REST::cosearch->new($args);
